...
public class AffectedCountries extends AppCompatActivity {
    ...
    MyCustomAdpater myCustomAdpater;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getActionBar().setTitle("Affected Countries");
        ...
        edtSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                myCustomAdpater.getFilter().filter(s);
                myCustomAdpater.notifyDataSetChanged();
        ...
        final StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response)
            {
                try {
                    ...
                    myCustomAdpater =new MyCustomAdpater(AffectedCountries.this,countryModelsList);
                    listView.setAdapter(myCustomAdpater);
